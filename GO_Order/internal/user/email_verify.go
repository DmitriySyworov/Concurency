...
func Send(conf *configs.VerifyEmail, emailUser, sessPassword string) error {
	...
	e.HTML = []byte(fmt.Sprintf(`Your code:

%s

Enter this code in the application or website to gain access to your account. 
If you did not request a code, simply ignore this email.`, sessPassword))
